...
export * from './lib/functions/dateInRange';
export * from './lib/functions/dateToString';
export * from './lib/functions/firstElement';
...
export * from './lib/functions/getFromLocalStorage';
...
export * from './lib/functions/lastElement';
...
export * from './lib/functions/setLocalStorageItem';
